...
function IconMastodon() {
  return (
    ...
    >
      <path 
        d="M20 6.56C20 2.23 16.94.94 16.94.94 13.97-.31 6.04-.31 3.06.94 3.06.94 0 2.24 0 6.56c0 5.17-.33 11.6 5.07 12.9 1.92.48 3.6.57 4.93.53 2.44-.13 3.78-.8 3.78-.8l-.05-1.65s-1.77.49-3.73.44c-1.91-.09-3.97-.22-4.26-2.4l-.04-.63c4.11.94 7.6.4 8.56.31 2.68-.31 5.02-1.87 5.3-3.26.49-2.23.44-5.44.44-5.44Zm-3.59 5.58h-2.25V7.05c0-2.23-3.06-2.32-3.06.31v2.81H8.9v-2.8c0-2.6-3.06-2.55-3.06-.32v5.09H3.59c0-5.45-.24-6.6.86-7.81 1.25-1.3 3.83-1.34 4.98.27l.57.89.57-.9c1.15-1.65 3.74-1.51 4.93-.26 1.15 1.25.91 2.36.91 7.8Z" 
        fill="currentColor" 
      />
    </svg>
  );
